export function extractDates(text: string): string[] {
  ...
  /* =========================
     ...
     ========================= */
  if (/\btoday\b/.test(lower)) results.push("today");
  if (/\btomorrow\b/.test(lower)) results.push("tomorrow");
  if (/\bnext\s+day\b/.test(lower)) results.push("tomorrow"); // "next day" = tomorrow
  if (/\byesterday\b/.test(lower)) results.push("yesterday");
